...
void recommencerPartie(CASE** tabCase, COMPTEUR* compteur, int* temps, int* cycle, ECECITY* JEU);
...
void construireBat(int categorieConstruction, int posXMouse, int posYMouse, Texture2D building, Texture2D Routes,VECTEUR mouseIso,CASE **tabCase, Texture2D centralEau, Texture2D centralEauBis, Texture2D centralElec, Texture2D centralElecBis, int rotation, int construire, ECECITY* JEU);
